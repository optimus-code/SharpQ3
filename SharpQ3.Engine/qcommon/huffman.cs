...
namespace SharpQ3.Engine.qcommon
{
	...
	public static class huffman
	{
		...
		static void	Huff_putBit( int bit, ref byte[] fout, ref int offset)
		{
			bloc = offset;
			if ((bloc&7) == 0) {
				fout[(bloc>>3)] = 0;
		...
		static int Huff_getBit( ref byte[] fin, ref int offset) 
		{
			int t;
			bloc = offset;
		...
		static void add_bit (char bit, ref byte[] fout) 
		{
			if ((bloc&7) == 0) {
				fout[(bloc>>3)] = 0;
			}
		...
		public static void Huff_Init(ref huffman_t huff)
		{
