...
{
	// cg_servercmds.c -- reliably sequenced text commands sent by the server these are processed at snapshot transition time,
	// so there will definately be a valid snapshot this frame
	public static class cg_servercmds
	{
		/*
		=================
		CG_ParseScores
