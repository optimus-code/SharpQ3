...
namespace SharpQ3.Engine.renderer
{
	public static class tr_image
	{
		...
		*/
		...
		static Image_Upload_Data generate_image_upload_data(const byte* data, int width, int height, bool mipmap, bool picmip) {
			//
			...
			R_LightScaleTexture(scaled_buffer, scaled_width, scaled_height, (bool) !mipmap);
