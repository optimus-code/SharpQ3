		...
		*/
		...
		intptr_t SV_GameSystemCalls( intptr_t *args ) {
			...
			case G_ENTITY_CONTACT:
				return SV_EntityContact((vec_t*) VMA(1), (vec_t*) VMA(2), (const sharedEntity_t*) VMA(3), /*int capsule*/ false);
			case G_ENTITY_CONTACTCAPSULE:
				return SV_EntityContact( (vec_t*) VMA(1), (vec_t*) VMA(2), (const sharedEntity_t*) VMA(3), /*int capsule*/ true );
			case G_TRACE:
				SV_Trace((trace_t*)VMA(1), (const vec_t*)VMA(2), (vec_t*) VMA(3), (vec_t*)VMA(4), (const vec_t*) VMA(5), args[6], args[7], /*int capsule*/ false);
				return 0;
			case G_TRACECAPSULE:
				SV_Trace((trace_t*)VMA(1), (const vec_t*)VMA(2), (vec_t*)VMA(3), (vec_t*)VMA(4), (const vec_t*)VMA(5), args[6], args[7], /*int capsule*/ true);
				return 0;
